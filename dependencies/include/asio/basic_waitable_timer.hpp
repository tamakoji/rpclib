 ...
 * clmdep_asio::steady_timer timer(my_context);
 *
 ...
 * @endcode
 *
 * @li The clmdep_asio::basic_waitable_timer::expires_after() function
...
public:
    ...
    : impl_(ex)
  {
    ...
    clmdep_asio::detail::throw_error(ec, "expires_after");
  }
