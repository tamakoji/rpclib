...
public:
  explicit handler_work(Handler& handler) ASIO_NOEXCEPT
    : io_executor_(),
      executor_(clmdep_asio::get_associated_executor(handler, io_executor_))
  {
  }
  ...
  {
    HandlerExecutor ex(clmdep_asio::get_associated_executor(handler));
    ex.on_work_started();
  }
  ...
  {
    HandlerExecutor ex(clmdep_asio::get_associated_executor(handler, io_ex));
    ex.on_work_started();
  ...
  void complete(Function& function, Handler& handler)
  {
    executor_.dispatch(ASIO_MOVE_CAST(Function)(function),
        clmdep_asio::get_associated_allocator(handler));
  }
