...
public:
    ...
    : count_(0), total_buffer_size_(0)
  {
    buffer_sequence_adapter::init(
        clmdep_asio::buffer_sequence_begin(buffer_sequence),
        clmdep_asio::buffer_sequence_end(buffer_sequence));
  }
...
class buffer_sequence_adapter<Buffer, clmdep_asio::mutable_buffer>
  : buffer_sequence_adapter_base
{
public:
  explicit buffer_sequence_adapter(
      const clmdep_asio::mutable_buffer& buffer_sequence)
  {
  ...
  static bool all_empty(const clmdep_asio::mutable_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const clmdep_asio::mutable_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const clmdep_asio::mutable_buffer& buffer_sequence)
  {
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, clmdep_asio::const_buffer>
  : buffer_sequence_adapter_base
{
public:
  explicit buffer_sequence_adapter(
      const clmdep_asio::const_buffer& buffer_sequence)
  {
    init_native_buffer(buffer_, Buffer(buffer_sequence));
    total_buffer_size_ = buffer_sequence.size();
  }
  ...
  static bool all_empty(const clmdep_asio::const_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const clmdep_asio::const_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const clmdep_asio::const_buffer& buffer_sequence)
  {
    return Buffer(buffer_sequence);
  }
