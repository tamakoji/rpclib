...
public:
  ...
  clmdep_asio::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, clmdep_asio::error_code& ec)
  {
    switch (w)
    {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    case posix::descriptor_base::wait_error:
        ...
        break;
      default:
        p.p->ec_ = clmdep_asio::error::invalid_argument;
