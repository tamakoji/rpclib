...
public:
   ...
   * @code
   * clmdep_asio::posix::stream_descriptor descriptor(my_context);
   * ...
   ...
   * clmdep_asio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(clmdep_asio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * clmdep_asio::error_code ec;
   * descriptor.wait(clmdep_asio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     clmdep_asio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   */
  template <
