 ...
 *
 * To submit functions to the io_context, use the @ref clmdep_asio::dispatch,
 * @ref clmdep_asio::post or @ref clmdep_asio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * clmdep_asio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * clmdep_asio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * clmdep_asio::executor_work_guard<io_context::executor_type>:
 *
 * @code clmdep_asio::io_context io_context;
 * clmdep_asio::executor_work_guard<clmdep_asio::io_context::executor_type>
 *   = clmdep_asio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  ASIO_DECL count_type run(clmdep_asio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  ASIO_DECL count_type run_one(clmdep_asio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll(clmdep_asio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll_one(clmdep_asio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use clmdep_asio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use clmdep_asio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use clmdep_asio::bind_executor().) Create a new handler that
...
public:
   ...
   */
  explicit work(clmdep_asio::io_context& io_context);
  ...
  clmdep_asio::io_context& get_io_context();
...
protected:
   ...
   */
  ASIO_DECL service(clmdep_asio::io_context& owner);
...
class service_base
  : public clmdep_asio::io_context::service
{
public:
  static clmdep_asio::detail::service_id<Type> id;

  // Constructor.
  service_base(clmdep_asio::io_context& io_context)
    : clmdep_asio::io_context::service(io_context)
  {
  }
};
