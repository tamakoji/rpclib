 ...
 * std::string n = clmdep_asio::read_until(s,
 *     clmdep_asio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, clmdep_asio::error_code& ec,
    typename enable_if<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
        && !is_dynamic_buffer_v2<typename decay<DynamicBuffer_v1>::type>::value
    >::type* = 0);
 ...
 * @code std::string data;
 * std::string n = clmdep_asio::read_until(s,
 *     clmdep_asio::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    const boost::regex& expr, clmdep_asio::error_code& ec,
    typename enable_if<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
        && !is_dynamic_buffer_v2<typename decay<DynamicBuffer_v1>::type>::value
    >::type* = 0);
 ...
 *     clmdep_asio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * clmdep_asio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * clmdep_asio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    clmdep_asio::basic_streambuf<Allocator>& b,
    ASIO_STRING_VIEW_PARAM delim, clmdep_asio::error_code& ec);
 ...
 * }
 * ...
 * clmdep_asio::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ...
 * std::string data;
 * clmdep_asio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * clmdep_asio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 */
