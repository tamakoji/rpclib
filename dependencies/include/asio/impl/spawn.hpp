    ...
    const boost::coroutines::attributes& attributes)
{
  ...
  clmdep_asio::spawn(ex, ASIO_MOVE_CAST(Function)(function), attributes);
}
...
{
  clmdep_asio::spawn(clmdep_asio::strand<Executor>(ex),
...
inline void spawn(const strand<Executor>& ex,
    ...
    const boost::coroutines::attributes& attributes)
{
  clmdep_asio::spawn(clmdep_asio::bind_executor(
        ex, &detail::default_spawn_handler),
      ASIO_MOVE_CAST(Function)(function), attributes);
}

template <typename Function>
inline void spawn(const clmdep_asio::io_context::strand& s,
    ASIO_MOVE_ARG(Function) function,
    const boost::coroutines::attributes& attributes)
{
  clmdep_asio::spawn(clmdep_asio::bind_executor(
...
{
  clmdep_asio::spawn(ctx.get_executor(),
      ASIO_MOVE_CAST(Function)(function), attributes);
}
