...
/** @defgroup buffer_sequence_begin clmdep_asio::buffer_sequence_begin
 *
 * @brief The clmdep_asio::buffer_sequence_begin function returns an iterator
...
/** @defgroup buffer_sequence_end clmdep_asio::buffer_sequence_end
 *
 * @brief The clmdep_asio::buffer_sequence_end function returns an iterator
 ...
 * auto i = clmdep_asio::buffer_sequence_begin(buffers);
 * auto end = clmdep_asio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
...
inline std::size_t buffer_size(const BufferSequence& b) ASIO_NOEXCEPT
{
  return detail::buffer_size(
      ...
      clmdep_asio::buffer_sequence_begin(b),
      clmdep_asio::buffer_sequence_end(b));
}
 ...
 * clmdep_asio::buffer_cast function is used to obtain a pointer to the
...
public:
  ...
  {
    return const_buffers_type(clmdep_asio::buffer(string_, size_));
  }
#endif // !defined(ASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(clmdep_asio::buffer(
          clmdep_asio::buffer(string_, max_size_) + pos, n));
  }
  ...
  {
    return const_buffers_type(clmdep_asio::buffer(
          clmdep_asio::buffer(string_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return clmdep_asio::buffer(clmdep_asio::buffer(string_) + size_, n);
  }
...
public:
  ...
  const_buffers_type data() const ASIO_NOEXCEPT
  {
    return const_buffers_type(clmdep_asio::buffer(vector_, size_));
  }
#endif // !defined(ASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(clmdep_asio::buffer(
          clmdep_asio::buffer(vector_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return clmdep_asio::buffer(clmdep_asio::buffer(vector_) + size_, n);
  }
...
/** @defgroup dynamic_buffer clmdep_asio::dynamic_buffer
 *
 * @brief The clmdep_asio::dynamic_buffer function is used to create a
    ...
    std::size_t max_bytes_to_copy) ASIO_NOEXCEPT
{
  return (buffer_copy_1)(*target_begin,
      clmdep_asio::buffer(*source_begin, max_bytes_to_copy));
}
      ...
      = (std::numeric_limits<std::size_t>::max)()) ASIO_NOEXCEPT
{
  ...
  for (mutable_buffer target_buffer(
        clmdep_asio::buffer(*target_begin, max_bytes_to_copy));
    ...
    std::size_t max_bytes_to_copy) ASIO_NOEXCEPT
{
      ...
      && target_iter != target_end && source_iter != source_end)
  {
    ...
    std::size_t bytes_copied = (buffer_copy_1)(
        target_buffer, clmdep_asio::buffer(source_buffer,
    ...
    const ConstBufferSequence& source) ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      clmdep_asio::buffer_sequence_begin(target),
      clmdep_asio::buffer_sequence_end(target),
      clmdep_asio::buffer_sequence_begin(source),
      clmdep_asio::buffer_sequence_end(source));
}
    ...
    std::size_t max_bytes_to_copy) ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      clmdep_asio::buffer_sequence_end(target),
      clmdep_asio::buffer_sequence_begin(source),
      clmdep_asio::buffer_sequence_end(source), max_bytes_to_copy);
}
...
struct is_mutable_buffer_sequence
  ...
  : clmdep_asio::detail::is_buffer_sequence<T, mutable_buffer>
...
struct is_const_buffer_sequence
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : clmdep_asio::detail::is_buffer_sequence<T, const_buffer>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer_v1
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : clmdep_asio::detail::is_dynamic_buffer_v1<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
#endif // !defined(ASIO_NO_DYNAMIC_BUFFER_V1)
...
struct is_dynamic_buffer_v2
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : clmdep_asio::detail::is_dynamic_buffer_v2<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer
  ...
  : clmdep_asio::is_dynamic_buffer_v2<T>
#else // defined(ASIO_NO_DYNAMIC_BUFFER_V1)
  : clmdep_asio::is_dynamic_buffer_v1<T>
#endif // defined(ASIO_NO_DYNAMIC_BUFFER_V1)
{
};
