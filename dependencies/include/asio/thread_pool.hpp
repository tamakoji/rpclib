 ...
 *
 * To submit functions to the thread_pool, use the @ref clmdep_asio::dispatch,
 ...
 * clmdep_asio::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * clmdep_asio::post(pool, my_task);
 *
 * // Submit a lambda object to the pool.
 * clmdep_asio::post(pool,
 *     []()
 *     {
 *       ...
 *     });
