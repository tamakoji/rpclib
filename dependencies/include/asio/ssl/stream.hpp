 ...
 * @code
 * clmdep_asio::io_context my_context;
 * clmdep_asio::ssl::context ctx(clmdep_asio::ssl::context::sslv23);
 * clmdep_asio::ssl::stream<asio:ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID shutdown(clmdep_asio::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      clmdep_asio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      clmdep_asio::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ShutdownHandler) handler) const
    {
      ...
      clmdep_asio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      clmdep_asio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      clmdep_asio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
