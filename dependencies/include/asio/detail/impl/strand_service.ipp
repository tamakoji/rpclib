...
strand_service::strand_service(clmdep_asio::io_context& io_context)
  : clmdep_asio::detail::service_base<strand_service>(io_context),
    io_context_(clmdep_asio::use_service<io_context_impl>(io_context)),
    mutex_(),
    salt_(0)
{
}
