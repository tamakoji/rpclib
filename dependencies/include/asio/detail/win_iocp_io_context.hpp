...
public:
  ...
  ASIO_DECL win_iocp_io_context(clmdep_asio::execution_context& ctx,
  ...
  ASIO_DECL size_t wait_one(long usec, clmdep_asio::error_code& ec);
...
private:
  ...
  // either 0 or 1).
  ASIO_DECL size_t do_one(DWORD msec, clmdep_asio::error_code& ec);
