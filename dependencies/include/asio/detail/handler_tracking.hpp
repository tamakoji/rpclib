...
# define ASIO_HANDLER_REACTOR_REGISTRATION(args) \
  clmdep_asio::detail::handler_tracking::reactor_registration args

# define ASIO_HANDLER_REACTOR_DEREGISTRATION(args) \
  clmdep_asio::detail::handler_tracking::reactor_deregistration args
...
# define ASIO_HANDLER_REACTOR_EVENTS(args) \
  clmdep_asio::detail::handler_tracking::reactor_events args

# define ASIO_HANDLER_REACTOR_OPERATION(args) \
  clmdep_asio::detail::handler_tracking::reactor_operation args
