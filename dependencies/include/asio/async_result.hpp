...
#define ASIO_COMPLETION_SIGNATURE \
  ::clmdep_asio::completion_signature
...
#define ASIO_COMPLETION_HANDLER_FOR(s) \
  ::clmdep_asio::completion_handler_for<s>
...
struct async_completion
{
  ...
  typedef typename clmdep_asio::async_result<
...
# define ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::clmdep_asio::detail::async_result_helper< \
    ct, sig>::return_type
...
# define ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::clmdep_asio::async_result< \
    typename ::clmdep_asio::decay<ct>::type, sig>::return_type
#define ASIO_HANDLER_TYPE(ct, sig) \
  typename ::clmdep_asio::async_result< \
    typename ::clmdep_asio::decay<ct>::type, sig>::completion_handler_type
#endif
...
#define ASIO_COMPLETION_TOKEN_FOR(s) \
  ::clmdep_asio::completion_token_for<s>
...
#define ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(e) \
  = typename ::clmdep_asio::default_completion_token<e>::type
