 ...
 * @c clmdep_asio::detached. For example:

 * @code my_socket.async_send(my_buffer, clmdep_asio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for clmdep_asio::detached_t for a usage example.
 */
