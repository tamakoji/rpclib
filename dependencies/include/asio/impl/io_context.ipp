...
{
  clmdep_asio::detail::scoped_ptr<impl_type> scoped_impl(impl);
  clmdep_asio::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(clmdep_asio::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(clmdep_asio::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(clmdep_asio::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(clmdep_asio::error_code& ec)
{
...
io_context::service::service(clmdep_asio::io_context& owner)
