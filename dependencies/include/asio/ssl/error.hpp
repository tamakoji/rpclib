...
static const clmdep_asio::error_category&
  ...
  = clmdep_asio::ssl::error::get_stream_category();
...
template<> struct is_error_code_enum<clmdep_asio::ssl::error::stream_errors>
{
  static const bool value = true;
};
...
inline clmdep_asio::error_code make_error_code(stream_errors e)
{
  return clmdep_asio::error_code(
