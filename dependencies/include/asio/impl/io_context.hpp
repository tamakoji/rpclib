...
#if !defined(ASIO_NO_DEPRECATED)
inline io_context::work::work(clmdep_asio::io_context& io_context)
...
inline clmdep_asio::io_context& io_context::work::get_io_context()
{
  return static_cast<clmdep_asio::io_context&>(io_context_impl_.context());
}
#endif // !defined(ASIO_NO_DEPRECATED)

inline clmdep_asio::io_context& io_context::service::get_io_context()
{
  return static_cast<clmdep_asio::io_context&>(context());
}
