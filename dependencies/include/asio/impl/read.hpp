...
namespace detail
{
      ...
      CompletionCondition completion_condition, clmdep_asio::error_code& ec)
  {
    ...
    clmdep_asio::detail::consuming_buffers<mutable_buffer,
    ...
    >::type*)
{
  return detail::read_buffer_sequence(s, buffers,
      clmdep_asio::buffer_sequence_begin(buffers),
...
namespace detail
{
  ...
  //private:
    typedef clmdep_asio::detail::consuming_buffers<mutable_buffer,
