 ...
 *       {
 *         state_ = writing;
 *         clmdep_asio::async_write(socket_, buffer_,
 *             clmdep_asio::transfer_exactly(n),
 *             std::move(self));
 *       }
 *       break;
 *     case writing:
 ...
 *       void(clmdep_asio::error_code, std::size_t)>::return_type
 * {
 *   return clmdep_asio::async_compose<CompletionToken,
